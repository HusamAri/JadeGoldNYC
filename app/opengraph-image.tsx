 ...
 * (#B89347) JG monogramı + ince altın kural çizgisi + "JADE GOLD · NEW YORK".
 * Ölçülü, marka-sadık ve yerel: harici CDN/font yok (next/og varsayılan Geist
 * fallback'i kullanılır). Marka monogramı `public/brand/logo/monogram-jg.svg`
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            <path d={JG_PATH_1} fill="#B89347" />
            <path d={JG_PATH_2} fill="#B89347" />
          </svg>
