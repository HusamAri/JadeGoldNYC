  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        "text-muted-foreground hover:text-foreground data-[state=active]:text-primary data-[state=active]:[background-image:var(--nm-convex)] data-[state=active]:shadow-[var(--shadow-raised-sm)] focus-visible:ring-ring/50 relative inline-flex h-full flex-1 cursor-pointer items-center justify-center gap-1.5 rounded-full px-3.5 py-1 font-mono text-xs font-medium tracking-[0.06em] uppercase whitespace-nowrap transition-[color,box-shadow,transform] [transition-duration:300ms,300ms,var(--motion-press-out)] [transition-timing-function:var(--ease-premium),var(--ease-premium),var(--ease-press-out)] active:scale-[0.96] active:[transition-duration:var(--motion-press-in)] outline-none focus-visible:ring-[3px] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
