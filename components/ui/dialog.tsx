...
function DialogOverlay({
  ...
  return (
    <DialogPrimitive.Overlay
      ...
      className={cn(
        // Karartma + hafif buzlanma — cam panel loş ortamın üstünde yüzer.
        "data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 fixed inset-0 z-50 bg-black/40 backdrop-blur-[3px] dark:bg-black/55",
        className,
      )}
      {...props}
    />
...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      className={cn(
        // Editorial serif panel başlığı (lab .glass h3 dili — Cormorant 500).
        "text-2xl leading-none font-medium tracking-[-0.02em] [font-family:var(--font-serif)]",
        className,
      )}
      {...props}
    />
