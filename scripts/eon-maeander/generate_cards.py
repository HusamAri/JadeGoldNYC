#!/usr/bin/env python3
"""Render EON Maeander Etsy information cards from the generated catalog."""
...
METAL_TONES = {
    ...
    ("10K", "White Gold"): "Cool silver white",
    ("14K", "White Gold"): "Neutral natural white",
    ("18K", "White Gold"): "Warm champagne white",
...
def draw_meander_rule(draw: ImageDraw.ImageDraw, accent: str, y: int) -> None:
    start_x = 170
...
def header(canvas: Image.Image, listing: dict, card_index: int, label: str) -> tuple[ImageDraw.ImageDraw, dict[str, str], str]:
    ...
    draw.text((170, 215), "MAEANDER 1008", font=SANS_26, fill=palette["muted"])
    ...
    draw_meander_rule(draw, accent, 1982)
...
def render_metal_karat(listing: dict) -> Image.Image:
    ...
    facts = [
        ...
        ("PATTERN", "Continuous Greek key"),
        ("BORDERS", "Fine milgrain and rope rails"),
