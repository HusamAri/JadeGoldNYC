...
select
  o.id,
  $ttg$TTG-R-1406$ttg$,
  $ttg$14K Two Tone Wedding Band, Solid Yellow and White Gold, Diamond Cut Comfort Fit$ttg$,
...
update public.products p set
  title = $ttg$14K Two Tone Wedding Band, Solid Yellow and White Gold, Diamond Cut Comfort Fit$ttg$,
